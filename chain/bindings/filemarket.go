...
// Extension2 is a free data retrieval call binding the contract method 0x67a2aaae.
//
// Solidity: function extension2() view returns(address)
func (_FileMarket *FileMarketCaller) Extension2(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _FileMarket.contract.Call(opts, &out, "extension2")
...
//
// Solidity: function extension2() view returns(address)
func (_FileMarket *FileMarketSession) Extension2() (common.Address, error) {
	return _FileMarket.Contract.Extension2(&_FileMarket.CallOpts)
}

// Extension2 is a free data retrieval call binding the contract method 0x67a2aaae.
//
// Solidity: function extension2() view returns(address)
func (_FileMarket *FileMarketCallerSession) Extension2() (common.Address, error) {
	return _FileMarket.Contract.Extension2(&_FileMarket.CallOpts)
}
...
//
// Solidity: function getOrderFinancials(uint256 _orderId) view returns(uint256 escrow_, uint256 withdrawn_, uint32 startPeriod_, bool expired_, address[] nodes_)
func (_FileMarket *FileMarketCaller) GetOrderFinancials(opts *bind.CallOpts, _orderId *big.Int) (struct {
	...
	outstruct.Withdrawn = *abi.ConvertType(out[1], new(*big.Int)).(**big.Int)
	outstruct.StartPeriod = *abi.ConvertType(out[2], new(uint32)).(*uint32)
...
// GetOrderPrice is a free data retrieval call binding the contract method 0x0f251358.
//
// Solidity: function getOrderPrice(uint256 _orderId) view returns(uint256)
func (_FileMarket *FileMarketCaller) GetOrderPrice(opts *bind.CallOpts, _orderId *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _FileMarket.contract.Call(opts, &out, "getOrderPrice", _orderId)
...
//
// Solidity: function getOrderPrice(uint256 _orderId) view returns(uint256)
func (_FileMarket *FileMarketSession) GetOrderPrice(_orderId *big.Int) (*big.Int, error) {
	return _FileMarket.Contract.GetOrderPrice(&_FileMarket.CallOpts, _orderId)
}

// GetOrderPrice is a free data retrieval call binding the contract method 0x0f251358.
//
// Solidity: function getOrderPrice(uint256 _orderId) view returns(uint256)
func (_FileMarket *FileMarketCallerSession) GetOrderPrice(_orderId *big.Int) (*big.Int, error) {
	return _FileMarket.Contract.GetOrderPrice(&_FileMarket.CallOpts, _orderId)
}
...
//
// Solidity: function onDemandChallenges(bytes32 ) view returns(uint64 deadlineBlock, uint256 randomness, address challenger, uint256 fileRoot, uint32 numChunks)
func (_FileMarket *FileMarketCaller) OnDemandChallenges(opts *bind.CallOpts, arg0 [32]byte) (struct {
	...
	outstruct.NumChunks = *abi.ConvertType(out[4], new(uint32)).(*uint32)
...
// OrderAssignments is a free data retrieval call binding the contract method 0x166f5cc8.
//
// Solidity: function orderAssignments(uint256 , uint256 ) view returns(address node, uint32 startPeriod)
func (_FileMarket *FileMarketCaller) OrderAssignments(opts *bind.CallOpts, arg0 *big.Int, arg1 *big.Int) (struct {
	Node        common.Address
	StartPeriod uint32
}, error) {
	var out []interface{}
	err := _FileMarket.contract.Call(opts, &out, "orderAssignments", arg0, arg1)
	...
	outstruct.StartPeriod = *abi.ConvertType(out[1], new(uint32)).(*uint32)
...
//
// Solidity: function orderAssignments(uint256 , uint256 ) view returns(address node, uint32 startPeriod)
func (_FileMarket *FileMarketSession) OrderAssignments(arg0 *big.Int, arg1 *big.Int) (struct {
	Node        common.Address
	StartPeriod uint32
}, error) {
	return _FileMarket.Contract.OrderAssignments(&_FileMarket.CallOpts, arg0, arg1)
}

// OrderAssignments is a free data retrieval call binding the contract method 0x166f5cc8.
//
// Solidity: function orderAssignments(uint256 , uint256 ) view returns(address node, uint32 startPeriod)
func (_FileMarket *FileMarketCallerSession) OrderAssignments(arg0 *big.Int, arg1 *big.Int) (struct {
	Node        common.Address
	StartPeriod uint32
}, error) {
	return _FileMarket.Contract.OrderAssignments(&_FileMarket.CallOpts, arg0, arg1)
...
// OrderUri is a free data retrieval call binding the contract method 0x7c34ec67.
//
// Solidity: function orderUri(uint256 ) view returns(string)
func (_FileMarket *FileMarketCaller) OrderUri(opts *bind.CallOpts, arg0 *big.Int) (string, error) {
	var out []interface{}
	err := _FileMarket.contract.Call(opts, &out, "orderUri", arg0)
...
//
// Solidity: function orderUri(uint256 ) view returns(string)
func (_FileMarket *FileMarketSession) OrderUri(arg0 *big.Int) (string, error) {
	return _FileMarket.Contract.OrderUri(&_FileMarket.CallOpts, arg0)
}

// OrderUri is a free data retrieval call binding the contract method 0x7c34ec67.
//
// Solidity: function orderUri(uint256 ) view returns(string)
func (_FileMarket *FileMarketCallerSession) OrderUri(arg0 *big.Int) (string, error) {
	return _FileMarket.Contract.OrderUri(&_FileMarket.CallOpts, arg0)
}

// Orders is a free data retrieval call binding the contract method 0xa85c38ef.
//
// Solidity: function orders(uint256 ) view returns(address owner, uint8 filled, uint8 replicas, uint32 numChunks, uint16 periods, uint32 startPeriod, uint256 fileRoot, uint256 escrow)
func (_FileMarket *FileMarketCaller) Orders(opts *bind.CallOpts, arg0 *big.Int) (struct {
	...
	outstruct.Owner = *abi.ConvertType(out[0], new(common.Address)).(*common.Address)
	outstruct.Filled = *abi.ConvertType(out[1], new(uint8)).(*uint8)
	outstruct.Replicas = *abi.ConvertType(out[2], new(uint8)).(*uint8)
	outstruct.NumChunks = *abi.ConvertType(out[3], new(uint32)).(*uint32)
	outstruct.Periods = *abi.ConvertType(out[4], new(uint16)).(*uint16)
	outstruct.StartPeriod = *abi.ConvertType(out[5], new(uint32)).(*uint32)
	outstruct.FileRoot = *abi.ConvertType(out[6], new(*big.Int)).(**big.Int)
	outstruct.Escrow = *abi.ConvertType(out[7], new(*big.Int)).(**big.Int)
...
//
// Solidity: function initialize(address _owner, address _nodeStaking) returns()
func (_FileMarket *FileMarketTransactor) Initialize(opts *bind.TransactOpts, _owner common.Address, _nodeStaking common.Address) (*types.Transaction, error) {
	return _FileMarket.contract.Transact(opts, "initialize", _owner, _nodeStaking)
}

// Initialize is a paid mutator transaction binding the contract method 0x485cc955.
//
// Solidity: function initialize(address _owner, address _nodeStaking) returns()
func (_FileMarket *FileMarketSession) Initialize(_owner common.Address, _nodeStaking common.Address) (*types.Transaction, error) {
	return _FileMarket.Contract.Initialize(&_FileMarket.TransactOpts, _owner, _nodeStaking)
}

// Initialize is a paid mutator transaction binding the contract method 0x485cc955.
//
// Solidity: function initialize(address _owner, address _nodeStaking) returns()
func (_FileMarket *FileMarketTransactorSession) Initialize(_owner common.Address, _nodeStaking common.Address) (*types.Transaction, error) {
	return _FileMarket.Contract.Initialize(&_FileMarket.TransactOpts, _owner, _nodeStaking)
}

// PlaceOrder is a paid mutator transaction binding the contract method 0x9e9e5253.
//
// Solidity: function placeOrder(uint256 _fileRoot, string _fileUri, uint32 _numChunks, uint16 _periods, uint8 _replicas, uint256 _pricePerChunkPerPeriod, uint256[4] _fspProof) payable returns(uint256 orderId)
func (_FileMarket *FileMarketTransactor) PlaceOrder(opts *bind.TransactOpts, _fileRoot *big.Int, _fileUri string, _numChunks uint32, _periods uint16, _replicas uint8, _pricePerChunkPerPeriod *big.Int, _fspProof [4]*big.Int) (*types.Transaction, error) {
	return _FileMarket.contract.Transact(opts, "placeOrder", _fileRoot, _fileUri, _numChunks, _periods, _replicas, _pricePerChunkPerPeriod, _fspProof)
}

// PlaceOrder is a paid mutator transaction binding the contract method 0x9e9e5253.
//
// Solidity: function placeOrder(uint256 _fileRoot, string _fileUri, uint32 _numChunks, uint16 _periods, uint8 _replicas, uint256 _pricePerChunkPerPeriod, uint256[4] _fspProof) payable returns(uint256 orderId)
func (_FileMarket *FileMarketSession) PlaceOrder(_fileRoot *big.Int, _fileUri string, _numChunks uint32, _periods uint16, _replicas uint8, _pricePerChunkPerPeriod *big.Int, _fspProof [4]*big.Int) (*types.Transaction, error) {
	return _FileMarket.Contract.PlaceOrder(&_FileMarket.TransactOpts, _fileRoot, _fileUri, _numChunks, _periods, _replicas, _pricePerChunkPerPeriod, _fspProof)
}

// PlaceOrder is a paid mutator transaction binding the contract method 0x9e9e5253.
//
// Solidity: function placeOrder(uint256 _fileRoot, string _fileUri, uint32 _numChunks, uint16 _periods, uint8 _replicas, uint256 _pricePerChunkPerPeriod, uint256[4] _fspProof) payable returns(uint256 orderId)
func (_FileMarket *FileMarketTransactorSession) PlaceOrder(_fileRoot *big.Int, _fileUri string, _numChunks uint32, _periods uint16, _replicas uint8, _pricePerChunkPerPeriod *big.Int, _fspProof [4]*big.Int) (*types.Transaction, error) {
	return _FileMarket.Contract.PlaceOrder(&_FileMarket.TransactOpts, _fileRoot, _fileUri, _numChunks, _periods, _replicas, _pricePerChunkPerPeriod, _fspProof)
}
